...
export const UserProfileCard = ({ user }) => {
  return (
    <Card as="div" className="min-w-[270px] max-w-[750px] w-full mt-4 bg-white/90 backdrop-blur-sm transition-all hover:shadow-lg">
      ...
      <CardContent>
        <div className="grid grid-cols-2 gap-4 mt-4">
          <div className="flex items-center gap-3 p-3 rounded-lg bg-primary/5 transition-colors hover:bg-primary/10">
